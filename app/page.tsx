Warning: truncated output (original token count: 55780)
Total output lines: 6163
  ...
  const generateScript = () => {
    ...
    setGeneratedScript({
      ...
      body: [
        ...
        `18–38 s · SOLUTION — Présente une méthode en trois temps : détecter les moments forts, adapter chaque extrait au réseau, puis progra…15780 tokens truncated…Click={() => void analyzeVideo()}
            ...
            <>
              <div className="cs2-page-title">
                ...
                <button
                  ...
                  onClick={() =>
                    notify(
                      "Configuration du paiement sécurisé bientôt disponible",
                    )
                  }
                >
